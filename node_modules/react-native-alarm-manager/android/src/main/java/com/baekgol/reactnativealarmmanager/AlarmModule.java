...
AlarmDto createAlarm(ReadableMap rm, boolean isModify){
    ...
    String alarmDateTime = rm.getString("alarm_time");
    String[] dateTimeInfo = alarmDateTime.split(" ");

    // Debugging statements
    System.out.println("Alarm DateTime: " + alarmDateTime);
    System.out.println("--------------------------Alarm DateTime:------------------------------ ");
    System.out.println("Date Time Info: " + Arrays.toString(dateTimeInfo));

    // Assuming your time format is "HH:mm:ss"
    String[] timeInfo = dateTimeInfo[0].split("-"); 

    // Debugging statement
    System.out.println("Time Info: " + Arrays.toString(timeInfo));

    newAlarm.setAlarmTime(Time.valueOf(timeInfo[0] + ":" + timeInfo[1] + ":00")); // Constructing time string in "HH:mm:ss" format
    newAlarm.setAlarmTitle(rm.getString("alarm_title"));
    newAlarm.setAlarmText(rm.getString("alarm_text") + " " + dateTimeInfo[1]);
    newAlarm.setAlarmSound(rm.getString("alarm_sound"));
    newAlarm.setAlarmIcon(rm.getString("alarm_icon"));
    newAlarm.setAlarmSoundLoop(rm.getBoolean("alarm_sound_loop"));
    newAlarm.setAlarmVibration(rm.getBoolean("alarm_vibration"));
